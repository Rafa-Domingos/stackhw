...
/* package stackhw-0.1.0.0 */
#define VERSION_stackhw "0.1.0.0"
#define MIN_VERSION_stackhw(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "stackhw-0.1.0.0-AZYNW7mRvIM4nFOe86Zo9r"

#define CURRENT_PACKAGE_KEY "stackhw-0.1.0.0-AZYNW7mRvIM4nFOe86Zo9r"
